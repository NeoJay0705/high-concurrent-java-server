...
public class PlatformThread {
    public static void main(String[] args) {
        ...
        ExecutorService executorService = Executors.newFixedThreadPool(threadPool); // A
                                                                                    // reasonable
                                                                                    // pool
        // size

        System.out.println(String.format("numberOfRequest=%,d, workLoop=%,d, threadPool=%,d",
                numberOfRequest, workLoop, threadPool));
